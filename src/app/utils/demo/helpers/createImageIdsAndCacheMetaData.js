...
export default async function createImageIdsAndCacheMetaData({
  ...
  //client = client || new api.DICOMwebClient({ url: wadoRsRoot, username: 'orthanc', password: 'orthanc' }); // JCMT
  ...
  console.log("CLIENT-------");
  console.log(client);
  console.log(client.retrieveSeriesMetadata);
  console.log(studySearchOptions);
  console.log("retrieve Series Metadata function");
  console.log(client.retrieveSeriesMetadata);

  let instances = await client.retrieveSeriesMetadata(studySearchOptions); // JCMT
  ...
  let imageIds = instances.map((instanceMetaData) => {
    ...
    /*console.log("META DATA MANAGER");
    console.log(cornerstoneDICOMImageLoader.wadors.metaDataManager);*/
