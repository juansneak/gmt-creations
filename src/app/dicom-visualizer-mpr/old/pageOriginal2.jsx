...
// const wadoRsRoot = 'http://orthanc-lb-1007112111.us-west-2.elb.amazonaws.com/dicom-web';
  ...
  */
  ...
  function initialize() {
    ...
    viewportGrid.style.gridTemplateColumns = `[col1-start] 30% [col2-start] 30% [col3-start] 30% [col4-start] 0% [col5-start] 10%[end]`;
    ...
    console.log("VIEWPORT GRID", viewportGrid);
    if (contentRef.current && viewportGrid) {
      console.log("ADDING VIEWPORT GRID TO CONTENT REF");
      contentRef.current.appendChild(viewportGrid);
    }
  ...
  function setUpToolGroups() {
    ...
    console.log('CT TOOL GROUP ID --------------');
    console.log(ctToolGroupId);
    
    console.log('ToolGroupManager.createToolGroup --------------');
    console.log(ToolGroupManager.createToolGroup);
    
    
    const ctToolGroup = ToolGroupManager.createToolGroup(ctToolGroupId);
    
    console.log('ctToolGroup --------------');
    console.log(ctToolGroup);
