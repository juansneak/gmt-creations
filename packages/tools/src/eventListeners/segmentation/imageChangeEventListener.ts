...
import type { SegmentationRepresentation } from '../../../dist/esm/types';
...
function _imageChangeEventListener(evt) {
  ...
  const representations = getSegmentationRepresentations(viewportId) as SegmentationRepresentation[];
